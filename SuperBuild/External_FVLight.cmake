...
set(extProjName FiberViewerLight) #The find_package known name
...
set(${proj}_DEPENDENCIES ITKv4 SlicerExecutionModel VTK QWT)
...
if(NOT ( DEFINED "USE_SYSTEM_${extProjName}" AND "${USE_SYSTEM_${extProjName}}" ) )
  ...
  ExternalProject_Add_Step(FiberViewerLight forcebuild
      COMMAND ${CMAKE_COMMAND} -E remove
      ${CMAKE_CURRENT_BUILD_DIR}/FiberViewerLight-prefix/src/FiberViewerLight-stamp/FiberViewerLight-build
      DEPENDEES configure
      DEPENDERS build
      ALWAYS 1
    )
