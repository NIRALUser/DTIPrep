...
void Protocol::initDiffusionProtocol()
{
	...
	diffusionProtocol.diffusionReplacedDWIFileNameSuffix = "_DiffusionReplaced.nhdr";
...
void Protocol::printImageProtocol()
{
	...
	std::cout<<"\tcroppedDWIFileNameSuffix: "<<  GetImageProtocol().croppedDWIFileNameSuffix <<std::endl;

	std::cout<<"\treportFileNameSuffix: "<<  GetImageProtocol().reportFileNameSuffix <<std::endl;
...
void Protocol::printDiffusionProtocol()
{
	...
	std::cout<<"\tDWMRI_b-value: "<< GetDiffusionProtocol().bValue<<std::endl;
	...
	std::cout<<"\tdiffusionReplacedDWIFileNameSuffix: "<<  GetDiffusionProtocol().diffusionReplacedDWIFileNameSuffix <<std::endl;

	std::cout<<"\treportFileNameSuffix: "<<  GetDiffusionProtocol().reportFileNameSuffix <<std::endl;
...
void Protocol::printSliceCheckProtocol()
{
	...
	std::cout<<"\tcheckTimes: "<< GetSliceCheckProtocol().checkTimes<<std::endl;

// 	std::cout<<"\tbadGradientPercentageTolerance: "<< GetSliceCheckProtocol().badGradientPercentageTolerance<<std::endl;

	std::cout<<"\theadSkipSlicePercentage: "<< GetSliceCheckProtocol().headSkipSlicePercentage <<std::endl;
	std::cout<<"\ttailSkipSlicePercentage: "<< GetSliceCheckProtocol().tailSkipSlicePercentage<<std::endl;

	std::cout<<"\tcorrelationDeviationThresholdbaseline: "<< GetSliceCheckProtocol().correlationDeviationThresholdbaseline<<std::endl;
	std::cout<<"\tcorrelationDeviationThresholdgradient: "<< GetSliceCheckProtocol().correlationDeviationThresholdgradient<<std::endl;

	std::cout<<"\toutputDWIFileNameSuffix: "<<  GetSliceCheckProtocol().outputDWIFileNameSuffix <<std::endl;
	std::cout<<"\treportFileNameSuffix: "<<  GetSliceCheckProtocol().reportFileNameSuffix <<std::endl;
...
// 	std::cout<<"\tbadGradientPercentageTolerance: "<< GetInterlaceCheckProtocol().badGradientPercentageTolerance<<std::endl;

	std::cout<<"\tcorrelationThresholdBaseline: "<< GetInterlaceCheckProtocol().correlationThresholdBaseline<<std::endl;
	std::cout<<"\tcorrelationDeviationBaseline: "<< GetInterlaceCheckProtocol().correlationDeviationBaseline<<std::endl;
	std::cout<<"\tcorrelationThresholdGradient: "<< GetInterlaceCheckProtocol().correlationThresholdGradient<<std::endl;
	std::cout<<"\tcorrelationDeviationGradient: "<< GetInterlaceCheckProtocol().correlationDeviationGradient<<std::endl;
	std::cout<<"\ttranslationThreshold: "<< GetInterlaceCheckProtocol().translationThreshold<<std::endl;
	std::cout<<"\trotationThreshold: "<< GetInterlaceCheckProtocol().rotationThreshold<<std::endl;

	std::cout<<"\toutputDWIFileNameSuffix: "<<  GetInterlaceCheckProtocol().outputDWIFileNameSuffix <<std::endl;
	std::cout<<"\treportFileNameSuffix: "<<  GetInterlaceCheckProtocol().reportFileNameSuffix <<std::endl;
...
// 	std::cout<<"\tbadGradientPercentageTolerance: "<< GetGradientCheckProtocol().badGradientPercentageTolerance<<std::endl;

	std::cout<<"\tgradientTranslationThreshold: "<< GetGradientCheckProtocol().translationThreshold<<std::endl;
	std::cout<<"\tgradientRotationThreshold: "<< GetGradientCheckProtocol().rotationThreshold<<std::endl;

	std::cout<<"\toutputDWIFileNameSuffix: "<<  GetGradientCheckProtocol().outputDWIFileNameSuffix <<std::endl;
	std::cout<<"\treportFileNameSuffix: "<<  GetGradientCheckProtocol().reportFileNameSuffix <<std::endl;
...
void Protocol::printBaselineAverageProtocol()
{
	...
	std::cout<<"\tstopThreshold: "<< GetBaselineAverageProtocol().stopThreshold <<std::endl;

	std::cout<<"\toutputDWIFileNameSuffix: "<<  GetBaselineAverageProtocol().outputDWIFileNameSuffix <<std::endl;
	std::cout<<"\treportFileNameSuffix: "<<  GetBaselineAverageProtocol().reportFileNameSuffix <<std::endl;
...
// 	std::cout<<"\tEddyCurrentCommand: "<< GetEddyMotionCorrectionProtocol().EddyMotionCommand<< std::endl;
//	std::cout<<"\tInputFileName: "<< GetEddyMotionCorrectionProtocol().InputFileName<< std::endl;
//	std::cout<<"\tOutputFileName: "<< GetEddyMotionCorrectionProtocol().OutputFileName<< std::endl;

	std::cout<<"\tnumberOfBins: "		<< GetEddyMotionCorrectionProtocol().numberOfBins << std::endl;
	std::cout<<"\tnumberOfSamples: "	<< GetEddyMotionCorrectionProtocol().numberOfSamples << std::endl;
	std::cout<<"\ttranslationScale: "	<< GetEddyMotionCorrectionProtocol().translationScale << std::endl;
	std::cout<<"\tstepLength: "			<< GetEddyMotionCorrectionProtocol().stepLength << std::endl;
	std::cout<<"\trelaxFactor: "		<< GetEddyMotionCorrectionProtocol().relaxFactor << std::endl;
	std::cout<<"\tmaxNumberOfIterations: "<< GetEddyMotionCorrectionProtocol().maxNumberOfIterations << std::endl;

	std::cout<<"\toutputDWIFileNameSuffix: "<<  GetEddyMotionCorrectionProtocol().outputDWIFileNameSuffix <<std::endl;
	std::cout<<"\treportFileNameSuffix: "<<  GetEddyMotionCorrectionProtocol().reportFileNameSuffix <<std::endl;
...
void Protocol::printDTIProtocol()
{
	...
	std::cout<<"\tdtiestimCommand: "<< GetDTIProtocol().dtiestimCommand << std::endl;
	std::cout<<"\tdtiprocessCommand: "<< GetDTIProtocol().dtiprocessCommand<< std::endl;
	...
	std::cout<<"\tbaselineThreshold: "<< GetDTIProtocol().baselineThreshold<<std::endl;
	...
	std::cout<<"\tcoloredfaSuffix: "<<GetDTIProtocol().coloredfaSuffix<<std::endl;

	if( GetDTIProtocol().bbaseline )
		std::cout<<"\tbbaseline: Yes"<<std::endl;
	else
		std::cout<<"\tbbaseline: No"<<std::endl;
	std::cout<<"\tbaselineSuffix: "<<GetDTIProtocol().baselineSuffix<<std::endl;

	if( GetDTIProtocol().bfrobeniusnorm )
		std::cout<<"\tbfrobeniusnorm: Yes"<<std::endl;
	else
		std::cout<<"\tbfrobeniusnorm: No"<<std::endl;
	std::cout<<"\tfrobeniusnormSuffix: "<<GetDTIProtocol().frobeniusnormSuffix<<std::endl;
...
void Protocol::collectDiffusionStatistics()
{
	...
	for( unsigned int i=0; i<this->GetDiffusionProtocol().gradients.size();i++)
	{
		if(DiffusionDirections.size()>0)
		{
			...
			{
				if( this->GetDiffusionProtocol().gradients[i][0] == DiffusionDirections[j].gradientDir[0] && 
					this->GetDiffusionProtocol().gradients[i][1] == DiffusionDirections[j].gradientDir[1] && 
					this->GetDiffusionProtocol().gradients[i][2] == DiffusionDirections[j].gradientDir[2] )
				{
