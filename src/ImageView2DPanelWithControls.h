...
class ImageView2DPanelWithControls : public QDockWidget, private Ui_ImageView2DPanelWithControls
{
    	Q_OBJECT
...
public:
	...
	void Update();
	inline vtkImageViewer2* GetImageViewer2(){ return ImageViewer2;};

	void toggle_toolButton_windowlevel_Syn(bool toggle)	{toolButton_windowlevel_Syn->setChecked(toggle);};
	void toggle_toolButton_orientation_Syn(bool toggle)	{toolButton_orientation_Syn->setChecked(toggle);};
	void toggle_toolButton_interpolation_Syn(bool toggle)	{toolButton_interpolation_Syn->setChecked(toggle);};
	void toggle_toolButton_content_Syn(bool toggle)		{toolButton_content_Syn->setChecked(toggle);};
...
public:
	QComboBox * GetComboBox_Interpolation(void) {return comboBox_Interpolation;};
	QComboBox * GetComboBox_Orientation(void) {return comboBox_Orientation;};
	QComboBox * GetComboBox_Contents(void) {return comboBox_Contents;};

	QSlider * GetHorizontalSlider_Gradient() {return horizontalSlider_Gradient;};
