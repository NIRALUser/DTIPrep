...
CRigidRegistration::CRigidRegistration(ImageType::Pointer fixed, ImageType::Pointer moving, unsigned int BinsNumber,double  SamplesPercent,bool	ExplicitPDFDerivatives )
{
	fixedImage = fixed;
	movingImage = moving;	
...
void CRigidRegistration::SetupFramework()
{
	...
	CommandIterationUpdate3DRigid::Pointer observer = CommandIterationUpdate3DRigid::New();
