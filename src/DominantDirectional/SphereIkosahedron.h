...
class ITK_EXPORT SphereIkosahedron : public DataObject
{
	...
	protected:
		...
		std::vector<std::vector<double> >	m_all_length;// Corresponding to m_all_triangs, for each triangle lengths of three edges are saved
...
void SphereIkosahedron< T >::ComputeSubdivision()
{
	...
	for (short i = 0; i< m_NumberOfTriangles ; i++ )
	{
		...
		double l1 = sqrt( (double) (v1[0]-v2[0])*(v1[0]-v2[0])+(v1[1]-v2[1])*(v1[1]-v2[1])+(v1[2]-v2[2])*(v1[2]-v2[2]) );
		double l2 = sqrt( (double) (v1[0]-v3[0])*(v1[0]-v3[0])+(v1[1]-v3[1])*(v1[1]-v3[1])+(v1[2]-v3[2])*(v1[2]-v3[2]) );
		double l3 = sqrt( (double) (v2[0]-v3[0])*(v2[0]-v3[0])+(v2[1]-v3[1])*(v2[1]-v3[1])+(v2[2]-v3[2])*(v2[2]-v3[2]) );
