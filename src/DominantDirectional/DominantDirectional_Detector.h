...
public:
  ...
  typedef itk::DiffusionTensor3DReconstructionImageFilter<ScalarPixelType, ScalarPixelType,
  ...
  double EstimateTensor_Whitematter_GrayMatter(std::string buffer1, std::string buffer2, std::string buffer3 /*,
                                                                                                               std::string
                                                                                                               buffer2
                                                                                                               */                      ,
                                               std::string buffer4);
...
protected:
  GradientDirectionContainerType::Pointer GradientDirectionContainer; // container to hold gradient directions of the
                                                                      // 'n' DW measurements
