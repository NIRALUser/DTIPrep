...
// This Class is used to apply further QC after including some gradients in visual checking step which were exclude
// before
...
public:
  ...
  CIntensityMotionCheck * mf_IntensityMotionCheck;      // pointer to the core function to show its long running for
                                                        // progressBar
