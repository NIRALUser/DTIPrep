                                      ...
                                      QTreeWidgetItem *item)
{
  ...
  if( pageString == "InterlaceAngleX" || pageString == "InterlaceAngleY" || pageString == "InterlaceAngleZ" )
    {
    if( item->text(1).toFloat() < protocol->GetInterlaceCheckProtocol().rotationThreshold )      // rotation threshold
                                                                                                 // in protocol
      {
  ...
  if( pageString == "InterlaceTranslationX" || pageString == "InterlaceTranslationY" || pageString ==
      "InterlaceTranslationZ" )
    {
    if( item->text(1).toFloat() < protocol->GetInterlaceCheckProtocol().translationThreshold )      // translation
                                                                                                    // threshold in
                                                                                                    // protocol
      {
      xmlWriter->writeTextElement("green", item->text(1) );
  ...
  if( pageString == "InterlaceCorrelation_Baseline" )
    ...
    if( item->text(1).toFloat() > protocol->GetInterlaceCheckProtocol().correlationThresholdBaseline )      //
      ...
      {
      xmlWriter->writeTextElement("green", item->text(1) );
      std::cout << "InterlaceCorrelation_Baseline"
                << protocol->GetInterlaceCheckProtocol().correlationThresholdBaseline << std::endl;
      }
    else
      {
      xmlWriter->writeTextElement("red", item->text(1) );
  ...
  if( pageString == "GradientAngleX" || pageString == "GradientAngleY" || pageString == "GradientAngleZ" )
    {
    if( item->text(1).toFloat() < protocol->GetGradientCheckProtocol().rotationThreshold )      // rotation threshold in
                                                                                                // protocol
      {
      xmlWriter->writeTextElement("green", item->text(1) );
      }
  ...
  if( pageString == "GradientTranslationX" || pageString == "GradientTranslationY" || pageString ==
      "GradientTranslationZ" )
    {
    if( item->text(1).toFloat() < protocol->GetGradientCheckProtocol().translationThreshold )      // translation
                                                                                                   // threshold in
                                                                                                   // protocol
      {
      xmlWriter->writeTextElement("green", item->text(1) );
...
void XmlStreamWriter::writeIndexEntry_Protocol(QXmlStreamWriter *xmlWriter,
                                               QTreeWidgetItem *item)
{
  if( !protocol )
    {
...
bool XmlStreamWriter::writeXml_Protocol(const QString & fileName)
{
  QFile file(fileName);
  ...
  for( int i = 0; i < treeWidget->topLevelItemCount(); ++i )
    {
    writeIndexEntry_Protocol( &xmlWriter, treeWidget->topLevelItem(i) );
    }
