...
void IntensityMotionCheckPanel::on_pushButton_RunPipeline_clicked( )
{
  ...
  //
  // IntensityMotionCheck(lineEdit_DWIFileName->text().toStdString());//,"report_54.txt");//
  ...
  ThreadIntensityMotionCheck->SetFileName(DwiFileName); //
                                                        // lineEdit_DWIFileName->text().toStdString()
  ThreadIntensityMotionCheck->SetProtocol( &protocol);
  ThreadIntensityMotionCheck->SetQCResult(&qcResult);
